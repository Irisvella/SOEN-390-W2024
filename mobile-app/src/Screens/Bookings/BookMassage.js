...
const BookMassage = ({ route, navigation }) => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Image source={require("../../../assets/massage.png")} style={styles.headerImage} />
      <TouchableOpacity style={styles.backButton} onPress={() => navigation.goBack()}>
                <MaterialIcons name="arrow-back-ios" size={26} color="#52575D" />
        </TouchableOpacity>
      <Text style={styles.headerText}>Massage Room Booking</Text>
      <View style={styles.descriptionContainer}>
        <Text style={styles.descriptionText}>
            Relax and rejuvenate in our tranquil massage room. Book your slot now to enjoy a soothing massage and unwind from the stresses of daily life.
        </Text>
      </View>
      <Calendar
