...
const BookSauna = ({ route, navigation }) => {
...
const bookSlot = async () => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.headerText}>Sauna Booking</Text>
      <View style={styles.descriptionContainer}>
        <Text style={styles.descriptionText}>
            Relax and unwind in our luxurious sauna. Book your slot now to enjoy a tranquil sauna session and rejuvenate your mind and body.
        </Text>
      </View>
      <Calendar
