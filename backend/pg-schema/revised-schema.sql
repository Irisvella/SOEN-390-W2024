...
CREATE TABLE property (
    ...
    registration_key uuid DEFAULT gen_random_uuid() UNIQUE
);
...
CREATE TABLE registration ( -- omitted company_id since it could be found using property_id
    ...
    registration_key uuid REFERENCES property(registration_key),
    ...
    PRIMARY KEY (registration_key, issued_at, public_user_id, property_id)
);
...
CREATE TABLE requests (
    ...
    employee_id INT REFERENCES public_users(user_id),
